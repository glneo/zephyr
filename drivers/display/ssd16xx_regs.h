...
#define SSD16XX_GEN1_CTRL2_TO_INITIAL		BIT(3)
#define SSD16XX_GEN1_CTRL2_TO_PATTERN		BIT(2)

#define SSD16XX_GEN2_CTRL2_MODE2		BIT(3) // 3-color vs BW
#define SSD16XX_GEN2_CTRL2_DISPLAY		BIT(2)
