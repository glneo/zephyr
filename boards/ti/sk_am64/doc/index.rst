...
See the `TI AM64X Product Page`_ for details.

Hardware
********
The SK-AM64 EVM features the AM62x SoC, which is composed of a quad Cortex-A53
...
The sk_am64/am6442/m4 configuration supports the following hardware features:
...
The SK-AM64 has a heartbeat LED connected to gpio6. It's configured
